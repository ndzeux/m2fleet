...
<svelte:head>
    <title>Features - Camera Integration</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/camera-integration" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                ...
                Capturing the picture inside/outside of vehicle using the camera extension devices. Some of the company need to apply this feature for monitoring driver, cargo and or road. Camera will take a picture every 1 hour and send to the server over RS232 port on GPS Device. M2Fleet can integrate maximum 3 camera in a single GPS.    
            </div>
            <div class="last-md first-xs" style="min-width:300px;padding-top:16px;text-align:center">
                <img src="/src/img/features/camera.jpeg" alt="Features">
            </div>
        </div>
    </div>
</div>
