...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/job-dispatch" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <h2>Job Dispatch</h2>
        Optimize and improve your business with our powerful and easy job management tool.<br>
        Take advantage of your mobile devices and have your jobs under control.
        <div style="text-align:center;padding-top:16px">
            <img src="/src/img/products/m2fleet_dispatch_jobsya.jpg" alt="Features">
        </div>
        <h2>Dispatch jobs to drivers using Garmin</h2>
        ...
        <h2>Schedule tasks from your office to your Fleet</h2>
        ...
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                <h2>Up-to-date workflow monitoring</h2>
                ...
                <h2>Real-time reporting and messaging</h2>
            ...
            <div class="last-md first-xs" style="min-width:300px;padding-top:16px;text-align:center">
                <img src="/src/img/solutions/t5.png" alt="Features" style="max-width:200px">
            </div>
        </div>
        <h2>Review and job history</h2>
