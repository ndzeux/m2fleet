...
<svelte:head>
    <title>Features - Fuel Consumption</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/fuel-consumption" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                ...
                <p>Real monitoring fuel consumption by install fuel sensor extension, the sensor will read the actual consumption and sent using GPS devices to the server</p>
            </div>
            <div class="last-md first-xs" style="min-width:300px;padding:16px 16px 0 16px;text-align:center">
                <img src="/src/img/features/f5.png" alt="Features">
            </div>
        </div>
        <h2>Fuel Sensor</h2>
        ...
        <div style="text-align:center;padding:16px 0">
            <img src="/src/img/solutions/t10.png" alt="Features">
        </div>
    </div>
</div>
