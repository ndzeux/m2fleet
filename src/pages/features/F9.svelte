...
<svelte:head>
    <title>Features - Mobile Application</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/mobile-application" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                ...
                The solution also provide mobile apps support to helping the fleet manager monitoring from mobile devices, whenever and anywhere you can monitor.
                <p>You can tracking your fleet using your mobile devices phone or ipad as well as desktop application</p>
            </div>
            <div class="last-md first-xs" style="min-width:200px;padding-top:16px;text-align:center">
                <img src="/src/img/features/f12.png" alt="Features">
            </div>
        </div>
    </div>
</div>
