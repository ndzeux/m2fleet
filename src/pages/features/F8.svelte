...
<svelte:head>
    <title>Features - RFID Receiver & Reader</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/rfid-receiver-&amp;-reader" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                <h2>GPS Build in RFID Receiver</h2>
                One of the solution to track non motorized asset, we provide a combination between GPS Device build in RFID Receiver to read RFID Tag Install on the asset.
                <p>You can tracking non-motorize asset using this solution by installing the GPS and RFID receiver for detecting RFID Tag in 50 meters, install the mobile vehicle to scan up around the asset, GPS will sending the asset position to the server.

                </p>
            </div>
            <div class="last-md first-xs" style="min-width:256px;padding:16px 16px 0 16px;text-align:center">
                <img src="/src/img/features/groundservice.png" alt="Features">
            </div>
        </div>
        <h2>RFID Devices</h2>
        RFID Receiver build in the GPS device and could scanning up to 100 asset / RFID Tag at the same time and send to server.
        <h2>How it work ?</h2>
        Our GPS will scan the RFID Radio around it (50 Meters) and send to server every minute
    </div>
</div>
