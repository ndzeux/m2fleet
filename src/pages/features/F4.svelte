...
<svelte:head>
    <title>Features - Job Dispatch</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/vehicle-maintenance" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                <h2>Vehicle Maintenance</h2>
                Vehicle Maintenance is a module management system specially designed for car, bus and truck operators. Module provides log event and reporting, planning, scheduled and unscheduled maintenance activity management, alerting to fleet manager.
                <p>You can get an email or SMS alert when maintenance schedule is overdue date and log the event when the maintenance done.</p>
            </div>
            <div class="last-md first-xs" style="min-width:300px;padding:16px 16px 0 16px;text-align:center">
                <img src="/src/img/features/vehiclem4inten4nce3.png" alt="Features">
            </div>
        </div>
        <h2>Scheduled Maintenance Activities</h2>
        To ensuring proper control of all safety issues and provides a complete solution for operators to manage and maintenance their vehicles for maximum efficiency and longevity in accordance with manufacturer's recommendations. It allows operators to create their own scheduled maintenance consisting of an unlimited number of user definable planned maintenance items. The activity cycle for each vehicle can be controlled by distance, days, hours or fixed date.
        <h2>Reporting</h2>
        Log reporting activity and scheduled could be print or email as is reporting format to help fleet manager doing the task.
        <div>
            <img src="/src/img/features/vehiclem4inten4nce2.png" alt="Features">
        </div>
    </div>
</div>
...
<style>
    ...
    .ppp h2:first-child{margin-top: 0;}
    .ppp > .row > div{
        padding:0
    }
    .ppp img{
