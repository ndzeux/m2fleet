...
<svelte:head>
    <title>Features - Temperature Sensor</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/features/temperature-sensor" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row center-xs">
            <div class="box col-md col-sm-12 col-xs-12" style="text-align:left">
                ...
                Cold chain logistics guarantees the quality and freshness of products. The temperature value in the cold chain vehicle body and the geographic location of cold chain vehicle will be monitored in real time. Our solution give the real time monitoring of temperature in vehicle.
                <p>You can tracking temperature in vehicle with in real time and the alert could be notify when the value of vehicle temperature offer the trashold value. It helping you to keep your goods fresh and accepted to your customers</p>
            </div>
            <div class="last-md first-xs" style="min-width:300px;padding:16px 16px 0 16px;text-align:center">
                <img src="/src/img/solutions/coldstor4ge.png" alt="Features">
            </div>
        </div>
        <h2>Temperature Devices</h2>
        Our GPS device and solution could be integrated with the real temperature sensor for controlling the vehicle.
        <h2>How it work ?</h2>
        Temperature extension devices will be install with GPS supported and send to vehicle tracking server.
    </div>
</div>
