...
<svelte:head>
    <title>Products - Advance Security Solutions</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a href="/products/advance-security-solutions" class="row middle-xs active" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <h1>Advance Security Solutions</h1>        
        <div style="text-align:center">
            <img src="/src/img/products/advss.png" alt="Products">
        </div>        
        <h3>Driver Monitoring System(DMS)</h3>
        Using DMS technology, the JC4D DashCam monitors for such potentially dangerous and illegal behaviors, then alerts the driver when signs of drowsiness or distraction are detected.
        <br>
        ...
        <br>
        <h3>JC4D DashCam</h3>
        The JC4D DashCam is our highest-level integrated video telematics solution for fleets. Using high-end DMS technology, you can capture what matters most, coach your drivers, mitigate risk, defend against fraudulent insurance claims, and protect your business' reputation. The JC4D dash cam works independently of any phone or hotspot, allowing for reliable and smooth recording on the road.
    </div>
</div>
