...
<svelte:head>
    <title>Products - Wireless Camera System</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a href="/products/wireless-camera-system" class="row middle-xs active" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
                <path fill="currentColor" d="M4,4H7L9,2H15L17,4H20A2,2 0 0,1 22,6V18A2,2 0 0,1 20,20H4A2,2 0 0,1 2,18V6A2,2 0 0,1 4,4M12,7A5,5 0 0,0 7,12A5,5 0 0,0 12,17A5,5 0 0,0 17,12A5,5 0 0,0 12,7M12,9A3,3 0 0,1 15,12A3,3 0 0,1 12,15A3,3 0 0,1 9,12A3,3 0 0,1 12,9Z"></path>
    ...
    <div class="ppp col-sm col-xs-12">
        <h1>Wireless Camera System</h1>        
        <div style="text-align:center">
            <img src="/src/img/products/wcs.jpeg" alt="Products">
        </div>        
            7 inch digital screen<br>
            Wireless transmit 100M<br>
            4 ways camera input<br>
            DVR recording support 128G<br>
            Product description: 7'' Wireless DVR Quad 4CH Cameras System, heavy duty truck camera system, crane lift truck rear view monitor, wireless camera for vehicle.
    </div>
</div>
