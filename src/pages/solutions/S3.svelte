...
<svelte:head>
    <title>Solutions - Car Rental</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/solutions/car-rental" use:link>
    ...
    <div class="ppp col-sm col-xs-12">
        ...
        <div class="table-box">
            <table>
                ...
                <tr>
                    <td>Real time fleet view</td>
                    <td>You directly locate a vehicle from the fleet manager interface. You can search by name, group or see the available vehicles in an specific area in the map.</td>
                    <td><img src="/src/img/solutions/t11.png" alt="Tabel Images"></td>
                </tr>
                <tr>
                    <td>Tag Vehicles</td>
                    <td>You can group vehicles into categories to quickly find the type that can perform the job better. The distance to the pick up is displayed for all vehicles.</td>
                    <td><img src="/src/img/solutions/t2.png" alt="Tabel Images"></td>
                </tr>
            </table>
        </div>
        <br>
        <h2>Recover a missing vehicle</h2>
        When a rental car is stolen it causes problems and costs large amounts for the car rental company. With this tools you can easily track in real time where your vehicle is and configure automatic alarms in case of exceeding predefined and configurable limits.
        <br>
        <div class="table-box">
            <table>
                <tr>
                ...
                <tr>
                    <td>Real time positioning</td>
                    <td>You can follow your vehicles and assets on a map in real time. Up-to-date vehicle locations and status information keeps you in control.</td>
                    <td><img src="/src/img/solutions/t11.png" alt="Tabel Images"></td>
                </tr>
                <tr>
                    <td>Geofences alarms</td>
                    <td>If a vehicle is leaving a predefined area the system can generate alerts based on geofences.</td>
                    <td><img src="/src/img/solutions/t13.png" alt="Tabel Images"></td>
                </tr>
                <tr>
                    <td>SMS / Email notification</td>
                    <td>If a vehicle is leaving a predefined area the system can generate alerts based on geofences.</td>
                    <td><img src="/src/img/solutions/t14.png" alt="Tabel Images"></td>
                </tr>
            </table>
        </div>
        <br>
        <h2>Evaluate your customer's driving behaviour</h2>
        The use of your vehicles by your customers over factors like excessive speed or harsh driving will dramatically reduce fuel consumption and increase your vehicle's lifetime. With M2Fleet Server car rental companies can offer a discount to customers that show that they have not been speeding during their car rental and/or got a good driving behaviour douring the car's usage. When the car is returned a speeding report can be printed and used in order to give your customer a compensation for his good behaviour. Is a win-win solution.
        <br>
        <div class="table-box">
            <table>
                <tr>
                ...
                <tr>
                    <td>Speeding alarms</td>
                    <td>You are able to set a maximum speed limit defined by company policy and if this limit is being surpassed you can set up notification alerts.</td>
                    <td><img src="/src/img/solutions/t6.png" alt="Tabel Images"></td>
                </tr>
                <tr>
                    <td>ECO driving reports</td>
                    <td>Get a driver rating based on harsh acceleration, breaking and speed.</td>
                    <td><img src="/src/img/solutions/t7.png" alt="Tabel Images"></td>
                </tr>
                <tr>
                    <td>Geofences Alarms</td>
                    <td>If a vehicle is leaving a predefined area the system can generate alerts based on geofences.</td>
                    <td><img src="/src/img/solutions/t12.png" alt="Tabel Images"></td>
                </tr>
            </table>
        </div>
        <br>
        <h2>Extend your fleet lifetime</h2>
        ...
        <div class="table-box">
            <table>
                ...
                <tr>
                    ...
                    <td>Keep track of when its time to perform a service of each vehicle in the fleet. Extend the lifetime of the fleet due to better control of service intervals.</td>
                    <td><img src="/src/img/solutions/t4.png" alt="Tabel Images"></td>
                </tr>
            </table>
        </div>
    </div>
