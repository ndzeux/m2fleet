...
<svelte:head>
    <title>Solutions - Asset Tracking</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/solutions/asset-tracking" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row top">
            <div class="col-sm col-xs-12">
                <h2>Asset and Vehicle Protection</h2>
                <h2>Do you have control over your vehicles and heavy machinery?</h2>
                ...
                <p>You can get an email or SMS alert when a vehicle is stolen and start tracking it in real time for fast recovery.</p>
            </div>
            <div style="text-align:center;padding-bottom:16px" class="col-sm-4 col-md-3 col-xs-12 first-xs last-sm">
                <img src="/src/img/solutions/sms3.png" alt="Solutions">
            </div>
        </div>
        ...
        <p>You can save money by avoiding that the vehicle is lost or damaged. Customers that are using this type of alerts report that they feel more secure and that they now have tool to quickly recover stolen property. Insurance companies may also offer you better terms when you can track your valuable assets.</p>
