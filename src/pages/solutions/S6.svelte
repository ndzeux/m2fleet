...
<svelte:head>
    <title>Solutions - Cold Chain Logistics</title>
</svelte:head>
...
<div class="products row start-xs">
    <div class="menu">
        ...
        <a class="row middle-xs active" href="/solutions/cold-chain-logistics" use:link>
            <svg viewBox="0 0 24 24" style="width:20px;height:20px;margin-right:4px">
    ...
    <div class="ppp col-sm col-xs-12">
        <div class="row middle-xs top">
            ...
            <div style="text-align:center;padding-bottom:16px" class="col-md-6 col-xs-12 first-xs last-md">
                <img src="/src/img/solutions/coldstor4ge.png" alt="Solutions">
            </div>
        </div>
